...
<section id="services">
  ...
  <div class="service">
    ...
    <div class="service">
      ...
      <p>Професійне чищення інтер'єру автомобіля, включаючи видалення пилу, плям, бруду, та інших забруднень з текстилю, шкіри та пластмасових елементів, використання спеціальних засобів та обладнання для ефективного очищення та дезінфекції.
.</p>
    </div>
